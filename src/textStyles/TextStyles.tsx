  ...
  return (
    <div className={`w-full ${className}`}>
      <div className={`mb-16 ${type !== 'all' && type !== 'heading' && 'display: hidden'}`}>
        <p className={['fontStyle-lg', 'uppercase', 'strong', 'text-gray-900', 'dark:text-gray-50', 'mb-6'].join(' ')}>Headings :</p>
        <div className="bg-gray-50 p-8 mb-4 rounded-2xl">
          <h1 className="fontStyle-9xl text-xxs">Heading 9x</h1>
          <pre className={['inline-block', 'px-2', 'py-1.5', 'mt-2', 'text-xs', 'font-mono', 'bg-gray-100', 'text-gray-600'].join(' ')}>
      ...
      <div
        className={`mb-16
              ...
              `}
      >
        <p className={['fontStyle-lg', 'uppercase', 'strong', 'text-gray-900', 'dark:text-gray-50', 'mb-6'].join(' ')}>Base large : </p>
        <div className="bg-gray-50 py-4 px-8 mb-4 rounded-2xl">
      ...
      <div
        className={`mb-16
              ...
              `}
      >
        <p className={['fontStyle-base', 'uppercase', 'text-gray-900', 'dark:text-gray-50', 'mb-6'].join(' ')}>Base : </p>
        <div className="bg-gray-50 py-4 px-8 mb-4 rounded-2xl">
      ...
      <div
        className={`mb-16
              ...
              `}
      >
        <p className={['fontStyle-sm', 'uppercase', 'strong', 'text-gray-900', 'dark:text-gray-50', 'mb-6'].join(' ')}>Base small : </p>
        <div className="bg-gray-50 py-4 px-8 mb-4 rounded-2xl">
      ...
      <div
        className={`mb-16
              ...
              `}
      >
        <p className={['fontStyle-xs', 'uppercase', 'strong', 'text-gray-900', 'dark:text-gray-50', 'mb-6'].join(' ')}>Base xsmall :</p>
        <div className="bg-gray-50 py-4 px-8 mb-4 rounded-2xl">
