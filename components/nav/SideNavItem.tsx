  ...
  return (
    <li
      className={`list-none border-l-2 pr-3 
        ...
        ${type === 'link' ? 'pl-7' : 'pl-5'} 
        ${status === 'default' ? 'border-gray-200 dark:border-gray-700' : 'border-brand-600 dark:border-brand-300 text-brand-700 dark:text-brand-200'} hover:border-brand-600 dark:hover:border-brand-300 hover:text-brand-700 dark:hover:text-brand-200 text-gray-600 dark:text-gray-300 cursor-pointer`}
    >
      {spacer ? '' :
        <a
          href={url ? url : '#'}
