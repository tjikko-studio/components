    ...
    return (
        <div
            ...
            className={`flex items-center
                ${(type == "special") && "px-3 py-2.5 fontStyle-body text-gray-100"}
                ...
                ${(type == "header") && "uppercase px-3 py-2.5 font-semibold tracking-wider text-gray-800 text-sm dark:text-gray-100"}
