    ...
    return (
        ...
        >
            ...
            <div className="col-span-2">
                <input
                    className={`${ !props.isDisabled && "hover:border-gray-300 dark:border-gray-400" } bg-gray-50 dark:bg-gray-800 dark:text-white text-base py-3 px-4 rounded-lg border border-gray-200  ${props.isDisabled && "dark:border-gray-500"} w-72 focus:outline-none focus:ring-2 focus:border-input_focus focus:shadow-input_focus focus:border-transparent font-inter
