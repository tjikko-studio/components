...
var Input = props => {
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    className: "text-sm font-inter font-semibold flex flex-row justify-between dark:text-gray-300 ".concat(props.isDisabled && "text-gray-500 dark:text-gray-600")
